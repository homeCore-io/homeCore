...
- Phase 2: next
  - In progress: added bridge admin command API baseline (`list_endpoints`, `get_endpoint`, `get_bridge_metrics` with paging/filter and structured error responses) for API/UI inventory and diagnostics use.
