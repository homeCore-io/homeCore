...
//!
//! Scope today: auth + users + api-keys + health + plugin-runtime enrollment.
//! Other endpoints (devices, rules, etc.) still use ad-hoc JSON on both sides
//! and will migrate lazily.
