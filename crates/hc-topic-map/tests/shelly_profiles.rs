...
fn gen1_relay_on() {
    ...
    let res = r
        .route_inbound("shellies/shellyplug-s-AABBCC/relay/0", b"on")
        .unwrap()
        .unwrap();
    match res {
        InboundResult::State {
...
fn gen1_relay_off() {
    let r = load_shelly_router();
    let res = r
        .route_inbound("shellies/shellyplug-s-AABBCC/relay/0", b"off")
        .unwrap()
        .unwrap();
    match res {
...
fn gen1_dual_relay_channel_1() {
    let r = load_shelly_router();
    let res = r
        .route_inbound("shellies/shelly25-112233/relay/1", b"on")
        .unwrap()
        .unwrap();
    match res {
        InboundResult::State {
...
fn gen1_relay_power() {
    let r = load_shelly_router();
    let res = r
        .route_inbound("shellies/shelly1pm-AABBCC/relay/0/power", b"57.3")
        .unwrap()
        .unwrap();
    match res {
        InboundResult::State {
...
fn gen1_ht_temperature() {
    let r = load_shelly_router();
    let res = r
        .route_inbound("shellies/shellyhthm-AABBCC/sensor/temperature", b"22.5")
        .unwrap()
        .unwrap();
    match res {
        InboundResult::State {
...
fn gen1_ht_humidity() {
    let r = load_shelly_router();
    let res = r
        .route_inbound("shellies/shellyhthm-AABBCC/sensor/humidity", b"65.0")
        .unwrap()
        .unwrap();
    match res {
...
fn gen1_door_window_closed() {
    let r = load_shelly_router();
    let res = r
        .route_inbound("shellies/shellydw-AABBCC/sensor/state", b"closed")
        .unwrap()
        .unwrap();
    match res {
...
fn gen1_door_window_open() {
    let r = load_shelly_router();
    let res = r
        .route_inbound("shellies/shellydw-AABBCC/sensor/state", b"open")
        .unwrap()
        .unwrap();
    match res {
...
fn gen1_flood_true() {
    let r = load_shelly_router();
    let res = r
        .route_inbound("shellies/shellyflood-AABBCC/sensor/flood", b"true")
        .unwrap()
        .unwrap();
    match res {
...
fn gen1_roller_state() {
    let r = load_shelly_router();
    let res = r
        .route_inbound("shellies/shelly25-AABBCC/roller/0", b"open")
        .unwrap()
        .unwrap();
    match res {
        InboundResult::State {
...
fn gen1_roller_position() {
    let r = load_shelly_router();
    let res = r
        .route_inbound("shellies/shelly25-AABBCC/roller/0/pos", b"75")
        .unwrap()
        .unwrap();
    match res {
...
fn gen1_roller_cmd_open() {
    ...
    assert_eq!(
        res.target_topic,
        "shellies/shelly25-AABBCC/roller/0/command"
    );
...
fn gen1_em_phase_power() {
    let r = load_shelly_router();
    let res = r
        .route_inbound("shellies/shelly3em-AABBCC/emeter/0/power", b"1196.5")
        .unwrap()
        .unwrap();
    match res {
        InboundResult::State {
...
fn gen1_availability_online() {
    let r = load_shelly_router();
    let res = r
        .route_inbound("shellies/shellyplug-s-AABBCC/online", b"true")
        .unwrap()
        .unwrap();
    match res {
...
fn gen1_availability_offline() {
    let r = load_shelly_router();
    let res = r
        .route_inbound("shellies/shellyplug-s-AABBCC/online", b"false")
        .unwrap()
        .unwrap();
    match res {
...
fn gen2_availability_online() {
    let r = load_shelly_router();
    let res = r
        .route_inbound("shellyplus2pm-083AF2123456/online", b"true")
        .unwrap()
        .unwrap();
    match res {
        InboundResult::Availability {
...
fn gen2_availability_offline() {
    let r = load_shelly_router();
    let res = r
        .route_inbound("shellyplus2pm-083AF2123456/online", b"false")
        .unwrap()
        .unwrap();
    match res {
        InboundResult::Availability { available, .. } => assert!(!available),
